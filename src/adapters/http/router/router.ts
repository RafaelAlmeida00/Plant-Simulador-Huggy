...
import { authMiddleware, optionalSessionFilterMiddleware } from '../middleware';
...
class AppRouter {
    ...
    initializeRoutes() {
        ...
        // GET routes use optional session filter (filter by session_id if provided)
        this.router.get('/api/events', authMiddleware, optionalSessionFilterMiddleware, (req, res) => EventsController.getAll(req, res));
        ...
        this.router.get('/api/stops', authMiddleware, optionalSessionFilterMiddleware, (req, res) => StopsController.getAll(req, res));
        this.router.get('/api/stops/active', authMiddleware, optionalSessionFilterMiddleware, (req, res) => StopsController.getActive(req, res));
        ...
        this.router.get('/api/buffers', authMiddleware, optionalSessionFilterMiddleware, (req, res) => BuffersController.getAll(req, res));
        this.router.get('/api/buffers/latest', authMiddleware, optionalSessionFilterMiddleware, (req, res) => BuffersController.getLatest(req, res));
        ...
        this.router.get('/api/plantstate', authMiddleware, optionalSessionFilterMiddleware, (req, res) => PlantStateController.getAll(req, res));
        this.router.get('/api/plantstate/latest', authMiddleware, optionalSessionFilterMiddleware, (req, res) => PlantStateController.getLatest(req, res));
        ...
        this.router.get('/api/oee', authMiddleware, optionalSessionFilterMiddleware, (req, res) => OEEController.getAll(req, res));
        ...
        this.router.get('/api/mttr-mtbf', authMiddleware, optionalSessionFilterMiddleware, (req, res) => MTTRMTBFController.getAll(req, res));
